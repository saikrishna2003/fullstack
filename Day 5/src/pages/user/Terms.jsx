      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <p className="text-lg mb-4">
            This page states the Terms and Conditions under which you (Visitor) may visit this Web site. Please read this
            page carefully. If you do not accept the Terms and Conditions stated here, we would request you to exit this
            site. Andor Tech (India) Pvt Ltd., any of its business divisions and / or its subsidiaries, associate companies
            or subsidiaries to subsidiaries or such other investment companies (in India or abroad) reserve their respective
            rights to revise these Terms and Conditions at any time by updating this posting. You should visit this page
            periodically to re-appraise yourself of the Terms and Conditions, because they are binding on all users of
            this Web Site.
          </p>
          <p className="text-lg mb-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg mb-4">
            You may not sell or modify the content of this Web Site or reproduce, display, publicly perform, distribute,
            or otherwise use the materials in any way for any public or commercial purpose without the respective organisation's
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">Links to Other Web Sites</h3>
          <p className="text-lg mb-4">
          ...
          <p className="text-lg mb-4">
            MomentousEndeavours has no control over, and assumes no responsibility for, the content, privacy policies, or practices
            of any third party web sites or services. You further acknowledge and agree that PartyOne shall not be responsible
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4">Changes</h3>
          <p className="text-lg mb-4">
