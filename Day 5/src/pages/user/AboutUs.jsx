...
import eventImage1 from '../../assets/images/event2.jpg';
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <img src={eventImage} alt="Event" className="w-full rounded-lg shadow-md mb-4 hover:scale-105 transition duration-300" />
            <img src={eventImage1} alt="Event" className="w-full rounded-lg shadow-md mb-4 hover:scale-105 transition duration-300" />
            <img src={eventImage3} alt="Event" className="w-full rounded-lg shadow-md hover:scale-105 transition duration-300" />
          </div>
